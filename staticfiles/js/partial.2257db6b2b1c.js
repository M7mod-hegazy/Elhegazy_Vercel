...
(function($) {
  ...
  document.querySelector('#gallery').querySelector('figure').each(function() {
    var $link = document.querySelector(this).querySelector('a'),
      item = {
        src: $link.attr('href'),
        w: $link.data('width'),
        h: $link.data('height'),
  ...
  document.querySelector('a').click(function(event) {

    // Prevent location change
    event.preventDefault();

    // Define object and gallery options
    var $pswp = document.querySelector('.pswp')[0],
      options = {
        index: document.querySelector(this).parent('figure').index(),
        bgOpacity: 0.85,
