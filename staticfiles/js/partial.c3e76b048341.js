...
document.querySelector(document).ready(function () {
  var $item = 0,
    $itemNo = document.querySelector(".hero figure").length;
  function transitionSlide() {
    $item++;
    if ($item > $itemNo - 1) {
      $item = 0;
    }
    document.querySelector(".hero figure").removeClass("on");
    document.querySelector(".hero figure").eq($item).classList.add("on");
  }
  var $autoTransition = setInterval(transitionSlide, 3500);

  document.querySelector(".hero figure").click(function () {
    clearInterval($autoTransition);
    $item = document.querySelector(this).index();
    document.querySelector(".hero figure").removeClass("on");
    document.querySelector(".hero figure").eq($item).classList.add("on");
