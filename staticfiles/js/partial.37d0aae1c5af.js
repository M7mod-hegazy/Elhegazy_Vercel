...
document.querySelector(document).ready(function () {
  ...
  document.querySelector(".slider-gallery").addEventListener("click", "img", function () {
  ...
  function moved() {
    ...
    document.querySelector(".slider-gallery").querySelector('[data-slide="' + owlDate.currentItem + '"]').classList.add("active");
  }
});
