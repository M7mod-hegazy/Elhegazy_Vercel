...
document.querySelector(document).ready(function () {
  ...
  var gallery = document.querySelector(".slider-gallery ul");
  var prev = document.querySelector(".prev.gallery-controls");
  var next = document.querySelector(".next.gallery-controls");
  var count = 0;
  var extraItem = gallery[0].childElementCount - 8;

  if (gallery[0].clientHeight > 450 && gallery[0].offsetTop === 0) {
    document.querySelector(".next.gallery-controls").classList.add("active");
  } else if (gallery[0].clientHeight > 450 && gallery[0].offsetTop > 0) {
    document.querySelector(".gallery-controls").classList.add("active");
  }
  ...
  prev.addEventListener("click", function () {
    ...
    if (count === 0) {
      document.querySelector(".prev.gallery-controls").removeClass("active");
    }
  });
  ...
  next.addEventListener("click", function () {
    ...
    if (count >= 1) {
      document.querySelector(".prev.gallery-controls").classList.add("active");
    }

    if (count === extraItem) {
      document.querySelector(".next.gallery-controls").removeClass("active");
    }
  });

  document.querySelector(".next.controls").click(function () {
    ...
    if (extraItem > 0) {
      ...
      if (owlDate.currentItem >= 7 && count > 1) {
        document
          .querySelector(".prev.gallery-controls")
      ...
      if (owlDate.currentItem === 0) {
        ...
        document.querySelector(".prev.gallery-controls").removeClass("active");
        document
          .querySelector(".next.gallery-controls")
          .classList.add("active");
      }
    }
  });

  document.querySelector(".prev.controls").click(function () {
  ...
  document.querySelector(".slider").addEventListener("mouseover", function (e) {
    document.querySelector(".slider").classList.add("active");
  });

  document.querySelector(".slider").addEventListener("mouseleave", function () {
    setTimeout(function () {
      document.querySelector(".slider").removeClass("active");
    }, 1500);
  });

  document
    .querySelector(".slider-gallery")
    .addEventListener("click", "img", function () {
      var sliderNum = document.querySelector(this).parent().data("slide");
      owl.trigger("owl.goTo", sliderNum);
    });

  function moved() {
    var $element = document.querySelector(".slider-gallery li");
    $element.removeClass("active");
    document
      .querySelector(".slider-gallery")
      .querySelector('[data-slide="' + owlDate.currentItem + '"]')
      .classList.add("active");
  }
});
